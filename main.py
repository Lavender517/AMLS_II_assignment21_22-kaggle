...
parser.add_argument('--early_stop_TH', type=int, default=15, help='The threshold value of the valid_loss continue_bigger_num in early stopping criterion')
parser.add_argument('--model', type=str, default='CNN', help='The specifc deep learning model to be chosed')
