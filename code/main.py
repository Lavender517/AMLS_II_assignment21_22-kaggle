...
from data_load import load_data, TwitterDataset
from data_preprocess import Preprocess, bert_tokenize_fn
from models import LSTM_Net, TextCNN
...
if device == torch.device('cuda'):
    device = args.device
w2v_path = 'w2v_all_' + str(args.embedding_dim) + '.model'
